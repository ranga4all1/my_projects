...
def main_flow(
    ...
    for email_address in email_addresses:
        subject = email_send_message.with_options(name=f"email {email_address}").submit(
            ...
            subject=f"Prefect Flow run {flow_run_name!r} executed now",
            msg=f"A new Prefect Flow run {flow_run_name!r} executed now - notification sent via email_send_message!",
